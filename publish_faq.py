...
def faq_grid_card_html(entry):
    ...
    return f"""      <a href="/faq/{slug}.html" class="faq-card" data-aos="fade-up">
        <span style="font-size:10px;font-weight:500;letter-spacing:2px;text-transform:uppercase;color:#C8A45C;display:block;margin-bottom:10px;">{category}</span>
...
<head>
  ...
  <style>
    *, *::before, *::after {{ box-sizing: border-box; }}
    ...
    .btn-primary {{
      display: inline-block; background: #C8A45C; color: #0D0D0D;
    ...
    .post-tag {{
      ...
      text-transform: uppercase; color: #C8A45C;
      border: 1px solid #C8A45C33; padding: 5px 12px; border-radius: 20px;
    }}
  </style>
...
{sections_html(sections)}
    ...
    <p style="color: #777; font-size: 15px;">
      ...
      {closing}<br><br>
      <a href="/contact.html" style="color: #C8A45C; text-decoration: underline; text-decoration-color: #C8A45C44;">Get in touch →</a>
    </p>
    ...
    <div style="background:#121212;border:1px solid #1e1e1e;border-radius:10px;padding:28px;display:flex;gap:20px;align-items:flex-start;">
      ...
      <div>
        ...
        <p style="color:#555;font-size:14px;line-height:1.6;margin:0;">
          ...
          <a href="https://www.linkedin.com/in/stewartmasters/" style="color:#C8A45C;text-decoration:none;">Connect on LinkedIn →</a>
        </p>
      </div>
    </div>
  </div>
